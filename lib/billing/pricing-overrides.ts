...
const DEFAULT_SERVICES: EditablePriceConfig['services'] = {
  ...
  openai_gpt5_2_input: { serviceKey: 'openai_gpt5_2_input', providerRate: 1.75 / 1_000_000, marginPercent: 45 },
  openai_gpt5_2_output: { serviceKey: 'openai_gpt5_2_output', providerRate: 14 / 1_000_000, marginPercent: 45 },
  openai_gpt5_2_cached_input: { serviceKey: 'openai_gpt5_2_cached_input', providerRate: 0.175 / 1_000_000, marginPercent: 45 },
