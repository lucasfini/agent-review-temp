  ...
  return (
    <div className="flex-shrink-0 w-full bg-amber-50 dark:bg-amber-950/60 border-b border-amber-300 dark:border-amber-700/60 text-amber-800 dark:text-amber-200 z-50">
      <div className="flex items-center justify-center gap-3 px-4 py-2 text-sm">
        ...
        <span className="font-medium">Demo Account — uploads enabled, settings locked.</span>
        <span className="hidden sm:inline text-amber-700/70 dark:text-amber-300/70">Try the workflow here, then sign up for a fully editable account.</span>
        <Link
          href="/auth/signup"
