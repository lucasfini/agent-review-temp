    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-slate-300">
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">1. Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">2. Service Description</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">3. Your Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">4. Acceptable Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">5. AI Processing</h2>
            <p>
              The service uses third-party AI providers (including OpenAI) to process audio, transcripts, and related
              metadata. If you opt in to data sharing, your data may be shared with OpenAI to receive free token benefits.
              You can change this preference at any time in Settings.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">6. Payments</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">7. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">8. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">9. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">10. Changes</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-50 mb-2">11. Contact</h2>
            <p>
